    ...
    <div>
      ...
      <div className={styles.body}>
        ...
        <section className={`${styles.ourMissionSection} ${styles.section}`}>
          ...
          <div className={styles.ourMissionTop}>
            <p className={styles.ourMissionText}>
              Think Different Academy je nezisková organizace zaměřená na rozvoj{" "}
              <b>kritického</b> myšlení a <b>logických</b> dovedností. <br />
              <br /> Naším cílem je vytvořit prostor, kde hráči mohou rozvíjet
              své dovednosti <b>zábavnou</b> formou. <br />
              <br /> Přidejte se k nám a objevte <b>nový svět</b> logických her.
            </p>
          </div>
          <div className={styles.ourMissionBottom}></div>
        </section>

        <section className={`${styles.aboutUsSection} ${styles.section}`}>
          <img src={darkMode ? redRiverLightMode : redRiverDarkMode} />
          <div>
            <p>
              ...
              který věrně zachovává atmosféru klasické hry na papíře, a zároveň
              nabízí pohodlí digitálního prostředí.
            </p>
            <Button
              text="Jdu do toho"
              backgroundColor="#0070BB"
          ...
          <img src={darkMode ? blueRiverLightMode : blueRiverDarkMode} alt="" />
          <div>
            <p>
              ...
              <br />
              <br />
              Každá úloha je navržena tak, aby tě posouvala na vyšší úroveň, ať
              už jsi <b>začátečník</b>, nebo <b>zkušený hráč</b>. <br />
              <br />
